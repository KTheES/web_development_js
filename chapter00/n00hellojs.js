...
// 길게 작성했을 경우에도 동일하게 우리는 Ctrl + /를 이용하여 주석 처리가 됩니다
...
// 오류 발생 사례
// A = 10;
// n00hellojs.js:30 Uncaught TypeError: Assignment to constant variable.
    // at n00hellojs.js:30:3 -> 라고 오류 발생함.

// Let c = 10; -> 동일한 변수를 두 번 선언했기 때문
// Let c = 12;

// Uncaught SyntaxError: Identifier 'c' has already been declared (at n00hellojs.js:35:5) ->  라고 오류 발생
...
// console.log(typeof bool01);   //boolaen
// Let z = 1;
...
//이상의 코드에서 알 수 있는 점은 조건식에 자주 사용되구요, 비교 연산의 결과값을 산출할 떄 많이 사용 됩니다.
